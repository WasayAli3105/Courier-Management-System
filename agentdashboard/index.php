                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card text-center order-visitor-card">
                                                            ...
                                                            <h6 class="m-b-0" name="processing"><?php echo 'PROCESSING' ?></h6>
                                                                <h4 class="m-t-15 m-b-15"><i class="fa fa-arrow-up m-r-15 text-c-green"></i><?php echo $process_count ?></h4>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card text-center order-visitor-card">
                                                            ...
                                                            <h6 class="m-b-0" name="delivered"><?php echo 'DELIVERED' ?></h6>
                                                                <h4 class="m-t-15 m-b-15"><i class="fa fa-arrow-down m-r-15 text-c-red"></i><?php echo $delivered_count ?></h4>
                                                                <p class="m-b-0">36% From Last 6 Months</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card text-center order-visitor-card">
                                                            <div class="card-block">
                                                                ...
                                                                <h4 class="m-t-15 m-b-15"><i class="fa fa-regular fa-newspaper m-r-15 text-c-yellow"></i>0</h4>
                                                                <p class="m-b-0">branch_name</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
